...
namespace CrateExpectations.Platform
{
    ...
    /// платформе, меняется одна строка в composition root. Ни один файл игрового кода
    /// про StubPlatformService не знает и знать не может - он видит только
    /// <see cref="IPlatformService"/>. Реальный SteamPlatformService встанет
