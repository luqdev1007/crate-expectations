...
namespace CrateExpectations.Player
{
    ...
    public sealed class PlayerMovementDefinition : ScriptableObject
    {
        ...
        [Tooltip("Максимальный угол наклона камеры (вниз). Полные 85 держатся не сами по себе, " +
                 "а на посадке глаза из FirstPersonCameraDefinition: при выносе 0.28 " +
                 "ближайшая ткань тела стоит в 0.131 м от камеры на ЛЮБОМ наклоне, то есть " +
                 "дальше ближней плоскости, и в объектив не попадает. Уменьшите вынос - " +
                 "и глаз вернётся внутрь воротника, а там уже никакой предел не спасает: " +
                 "изнанка видна на всех углах, проверено")]
