...
namespace CrateExpectations.Core.View
{
    ...
    public sealed class CameraBillboard : MonoBehaviour
    {
        ...
        public void FaceCamera()
        {
            ...
            // Копия ориентации камеры держит плашку строго параллельной экрану с любого ракурса
            // (LookAt целится в точку осью Z и оставляет up мировым, отчего при взгляде сверху
            // или снизу плашку кренит, а над объектом - переворачивает)
